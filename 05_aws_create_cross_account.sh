...
then
    ...
    aws iam create-policy  --policy-name ${prefix}-cross-account-minimal-policy --policy-document file://${BASE_DIR}/credential-policies/aws-cross-account-minimal-policy.json  > /dev/null 2>&1
    sleep $sleep_duration
